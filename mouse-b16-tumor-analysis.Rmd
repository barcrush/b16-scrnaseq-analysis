---
title: "Single-cell RNA-seq analysis of B16 tumor infiltrating immune cells"
author: Yogesh Maithania
date: "December 12, 2025 \n\n[GitHub Repo](https://github.com/barcrush/b16-brnaseq-analysis)"
output:
  html_document:
    toc: true
    toc_float: true
...
The data can be downloaded from: https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE110746. Scroll to the bottom of that webpage and download the three files: GSE110746_barcodes.tsv.gz, GSE110746_genes.tsv.gz, and GSE110746_matrix.mtx.gz. These are a set of matrices which dictate the cellular barcode, gene name, and expression values for each cell. These matricies are the standardized output provided by the 10X Genomics software Cell Ranger after processing the raw fastq files.
...
# save(b16, file = "output/b16_all_v3.Robj")
```
...
```{r include=F}
load("output/CD8_ADAR_vs_Control_ranked.Robj")
```
